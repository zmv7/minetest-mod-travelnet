...
if( minetest.registered_nodes["default:glass"]) then
   travelnet.register_door( "travelnet:elevator_door_steel", {"travelnet_steel.png"}, "default:steel_ingot");
   travelnet.register_door( "travelnet:elevator_door_glass", {"travelnet_elevator_door_glass.png"}, "default:glass");
   travelnet.register_door( "travelnet:elevator_door_tin", {"travelnet_tin.png"}, "default:tin_ingot");
end
